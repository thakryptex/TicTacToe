...
public class Game implements Runnable {
    ...
    public static void startGame() {
        ...
        // Логика игры запускается в другом потоке
    ...
    private void playing() {
        numOfSteps = 0;
        // выполняется пока игру никто не выиграл или пока не наступила ничья
        while (gamePlaying) {
            Point point;
            numOfSteps++;
            // если ход игрока
            ...
            if (numOfSteps >= 5) {
                ...
                // если после 9ти шагов никто не выиграл, то "ничья"
                else if (numOfSteps == 9) {
                    gamePlaying = false; winner = "Nobody";
                }

                // если игра закончилась, то вызывается диалоговое окно
                if (!gamePlaying) {
